    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10' >
      ...
      gap-10 md:gap-10 py-10 border-b border-white/30'>
        ...
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <ul className='flex md:flex-col w-full justify-between text-white/80 text-sm
          md:space-y-2  '>
            <li><a href="#">Home</a></li>
        ...
        <div className='hidden md:flex flex-col items-start w-full '>
          ...
          <p className='text-sm text-white/80'>The latest news and articles sent your inbox weekly </p>
