            ...
            <tbody className="text-sm text-gray-500">
              {courses.map((course) => (
                <tr key={course._id} className="border-b border-gray-500/20">
                  <td
                    className="md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3 
                  truncate"
                  >
                    <img
                  ...
                  <td className="px-4 py-3">
                    {console.log("CreatedAt value:", course.createdAt)}
                    {course.createdAt && !isNaN(Date.parse(course.createdAt))
